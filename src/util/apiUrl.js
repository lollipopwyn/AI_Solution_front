...
const GET_USER_TASKS_API_URL =
  'https://solutionbackend.bstuz.com/get_UserTasks';

const POST_STATUS_TASKS_API_URL =
  'https://solutionbackend.bstuz.com/post_status';

const UPDADTE_AGREE_STATUS_API_URL =
  'https://solutionbackend.bstuz.com/update_status';
const UPDADTE_AGREE_STATUS_COMMENT_API_URL =
  'https://solutionbackend.bstuz.com/update_comment_status';
const DELETE_TASKS_API_URL = 'https://solutionbackend.bstuz.com/delete_task';

//Mypage 협의서 수정
const UPDATE_USER_AGREE_API_URL =
  'https://solutionbackend.bstuz.com/update_agree';
